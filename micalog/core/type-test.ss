...
(define $scope
  (fluent (empty-scope)
    ...
    (scope+undefined #'bar-4 #'(%wire 4 bar-4))
    (scope+undefined #'foo-8 #'(%wire 8 foo-8))
    (scope+undefined #'bar-8 #'(%wire 8 bar-8))
    (scope+undefined #'reg-foo-4 #'(%register 4 reg-foo-4))
    (scope+undefined #'reg-bar-4 #'(%register 4 reg-bar-4))
    (scope+undefined #'reg-bar-8 #'(%register 8 reg-bar-8))
    (scope+undefined #'zoo-1 #'(%wire 1 renamed-zoo-1))))
