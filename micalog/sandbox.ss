...
(display
  (micalog->verilog-string
    (module
      ...
      (input 16 mouse-x)
      (internal 1 half-clock (register 1 0 (on (posedge clock) inv-half-clock)))
      (internal 1 previous-half-clock (register 1 0 (on (negedge clock) half-clock)))
      (internal 1 next-half-clock (not 16 previous-half-clock))
      (internal 16 counter (register 16 0 (on (posedge half-clock) next-counter)))
      (internal 16 previous-counter (register 16 0 (on (negedge half-clock) counter)))
