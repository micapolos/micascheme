...
(define assemble-instruction
  (macro-rules
    ...
    ; 8-bit alu
    (((alu $a) a (r $r))    (db-233 #b10 $a $r))
    (((alu $a) a (p $p))    (db #xdd) (db-233 #b10 $a $p))
    (((alu $a) a (q $q))    (db #xfd) (db-233 #b10 $a $q))
    (((alu $a) a (hl))      (db-233 #b10 $a #b110))
    (((alu $a) a (+ ix $d)) (db #xdd) (db-233 #b10 $a #b110) (db $d))
    ...
    (((incr $i) (hl))       (db-233 #b00 #b110 $i))
    (((incr $i) (+ ix $d))  (db #xdd) (db-233 #b00 #b110 $i) (db $d))
    (((incr $i) (+ iy $d))  (db #xfd) (db-233 #b00 #b110 $i) (db $d))
    ...
    ((ld (rr $rr) $nm)      (db-224 #b00 $rr #b0011) (dw $nm))
    ((ld ix $nm)            (db #xdd) (db-224 #b00 $rr #b0011) (dw $nm))
    ((ld iy $nm)            (db #xfd) (db-224 #b00 $rr #b0011) (dw $nm))
    ...
    ((inc (rr $rr))         (db-224 #b00 $rr #b0011))
    ((inc (rr-ix $rr))      (db #xdd) (db-224 #b00 $rr #b0011))
    ((inc (rr-iy $rr))      (db #xfd) (db-224 #b00 $rr #b0011))
    ((dec (rr $rr))         (db-224 #b00 $rr #b1011))
    ((dec (rr-ix $rr))      (db #xdd) (db-224 #b00 $rr #b1011))
    ((dec (rr-iy $rr))      (db #xfd) (db-224 #b00 $rr #b1011))
