  ...
  (define (syntax->typed-noexpand $lookup $syntax)
    (syntax-case $syntax
      (
        ...
        db-binary dw-binary binary-append binary->bytevector zero-binary bytevector-binary
        bytevector let
        u2 u3 u8 u16 s8)
      ((typed typ expr)
      ...
      ((bytevector-binary expr)
        (typed #'binary
          #`(bytevector-binary #,(syntax->expr $lookup #'bytevector #'expr))))
      ((binary-append expr ...)
        (typed #'binary
          #`(binary-append
