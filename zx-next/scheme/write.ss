    ...
    (dispatch
      ...
      (begin
        ...
        (dispatch
          ...
          (write-unknown-constant #x10)
          (write-unknown-constant #x11)
          (write-unknown-constant #x12)
          (write-unknown-constant #x13)
          (write-unknown-constant #x14)
          (write-unknown-constant #x15)
          (write-unknown-constant #x16)
          (write-unknown-constant #x17)
          (write-unknown-constant #x18)
